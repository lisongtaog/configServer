...
import com.bestgo.common.util.ObjectUtils;
...
public class DataUtils {
    ...
    /**
     * 当整型数值为0时,返回字符串"",否则将整型值转化为字符串返回. <br> <br> <b>示例 </b> <code>
    ...
    /**
     * 当浮点型数值为0时,返回字符串"",否则将浮点型值转化为字符串返回. <br> <br> <b>示例 </b> <code>
    ...
    /**
     * 当字符串为null时,返回字符串"". <br> <br> <b>示例 </b> <code>
    ...
    /**
     * 当字符串为""时,返回null. <br> <br> <b>示例 </b> <code>
     * <br>DataUtils.nullToEmpty(null) 返回 null
    ...
    /**
     * 当字符串为"null"或为null时,返回字符串"". <br> <br> <b>示例 </b> <code>
    ...
    /**
     * 当字符串为null或""或全部为空格时,返回字符串"0",否则将字符串原封不动的返回. <br> <br> <b>示例 </b> <code>
    ...
    /**
     * 对表达布尔型含义的字符串转换为中文的"是"/"否". <br> <br> <b>示例 </b> <code>
     ...
     *        <br> 除了上述合法的入参值之外，输入其它的字符串，将抛出异常
    ...
    /**
     * 对表达布尔型含义的字符串转换为boolean型的true/false. <br> <br> <b>示例 </b> <code>
    ...
    /**
     * 返回对应boolean型变量的字符串型中文描述：'是'/'否'. <br> <br> <b>示例 </b> <code>
     * <br>DataUtils.getBooleanDescribe(true) 返回 '是'
     * <br>DataUtils.getBooleanDescribe(false) 返回 '否'
     * </code>
     * 
    ...
    /**
     * 比较两个存放了数字的字符串的大小，如果不为数字将抛出异常. <br> <br> <b>示例 </b> <code>
    ...
    /**
     * 提供精确的小数位四舍五入处理. <br> <br> <b>示例 </b> <code>
            ...
            for(Iterator iter = targetMethodList.iterator(); iter.hasNext();) {
                ...
                try {
                    ...
                    if(value != null) {
                        ...
                        // Timestamp.class) {
                        // value = new Timestamp(((DateTime) value).getTime());
                        // } else if (value.getClass() == DateTime.class
                        // && method.getParameterTypes()[0].getClass() ==
                        // Timestamp.class) {
                        // value = new DateTime(new Date(((Timestamp) value)
                        // .getTime()));
                        // }
                    ...
                    // e.printStackTrace();
                    System.out.println("===copySimpleObject exception="
                            + e.getMessage());
                }
            }
        }
    ...
    /**
     * 把通过JdbcTemplate查出的结果集封装到List中<br> 只要字段名和DTO的属性名能对应上的就把值封装进去，对应不上的就不管了
     * 
