...
public class StringUtils {
	 ...
	 * corpration&quot;,&quot;soft&quot;,0,2) 返回 14
	 * StringUtils.indexOf(&quot;ab ab ab ab&quot;,&quot;a&quot;,4,2) 返回 9
	 * StringUtils.indexOf(&quot;ab ab ab ab&quot;,&quot;a&quot;,4,3) 返回 -1
	 * 
	 * @param str
	 *              主字符串,字符串的值不能为null
	 * @param subStr
	 ...
	 * is Peter&quot; <br>
	 * StringUtils.replace(&quot;Tom's name is
	 * Tom&quot;,&quot;tom&quot;,&quot;Peter&quot;,true) 返回 &quot;Tom's name
	 * is Tom&quot; <br>
	 * StringUtils.replace(&quot;Tom's name is
	 ...
	 * String[]{&quot;abcd&quot;,&quot;&quot;}
	 * StringUtils.split(&quot;&circ;abcd&circ;&quot;,&quot;&circ;&quot;) 返回
	 * new String[]{&quot;&quot;,&quot;abcd&quot;,&quot;&quot;}
	 ...
	 * @return
	 */
	public static String formatRichText(String richText){
		String result = richText;
		//去除所有非标签本身、标签文本外的内容
		result = result.replaceAll("<(/?\\S+)\\s*?[^<]*?(/?)>","<$1$2>");
		
		String regex = "(<br>|<b>|<p>|<h1>|<h2>|<h3>|<h4>|<h5>)";
		result = Pattern.compile(regex,Pattern.CASE_INSENSITIVE).matcher(result).replaceAll("");
		regex = regex.replace("<", "</");//结束标签
		result = Pattern.compile(regex,Pattern.CASE_INSENSITIVE).matcher(result).replaceAll("\r\n");
		regex = "(<span>|</span>|<br/>)";
		result = Pattern.compile(regex,Pattern.CASE_INSENSITIVE).matcher(result).replaceAll("");
		return result;
