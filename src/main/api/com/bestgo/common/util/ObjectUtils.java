...
public final class ObjectUtils {
	...
	/**
	 * Returns the classname without the package. Example: If the input class
	 * is java.lang.String than the return value is String.
	 * 
	 * @param cl
	...
	public static void main(String[] args) {
		List list = getGetter(BusinessException.class);
		...
		// }
		// else {
		// className = JOptionPane.showInputDialog("Input class name (e.g.
		// java.util.Date): ");
		// }
		// try {
